...
<template>
	<v-container fluid grid-list-xl style="background-color: #757575">
		<v-layout row wrap justify-content-center my-3 mx-3>
			...
			<v-flex xs12 sm8 md7>
				<v-layout style="padding-top: 12px" justify-center>
	...
	import draggable from 'vuedraggable'
  	export default {
	    ...
	    mounted(){
    		...
    		axios.get(settings.root_url + '/api/printer/init-create/' + this.$route.params.id)
            .then(response => {
                ...
                bgImage.setSrc(settings.root_url + '/users/' + this.user.name + '/printer-templates/' + response.data.bg.file, function(img){
